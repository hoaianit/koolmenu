...
//	private $db_user    = "pratt038_phpuser";       // user name0
//	private $db_pass    = "ppratt123";           // password
//	private $db_dbname  = "pratt038_buildtest";           // database name
//	private $db_charset = "utf8";           // optional character set (i.e. utf8)
//	private $db_pcon    = false;        // use persistent connection?

	private $db_host    = "prattcan.netfirmsmysql.com";  // server name 
	private $db_user    = "prattdbuser";       // user name
	private $db_pass    = "dbpassword";           // password
	private $db_dbname  = "prattbuild_db";           // database name
	private $db_charset = "utf8";           // optional character set (i.e. utf8)
	private $db_pcon    = false;        // use persistent connection?
